...
<head>
    ...
    <link rel="stylesheet" href="../styles/css/security_style.css">
</head>
<body>
<div class="container-xl px-4 mt-4">
    ...
    <nav class="nav nav-borders">
        ...
        <a class="nav-link" href="profile_wali">Profile Wali</a>
        <a class="nav-link active" href="security">Keamanan Akun</a>
